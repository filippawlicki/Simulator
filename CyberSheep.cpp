...
CyberSheep::CyberSheep(World &world, const Point &position) : Animal(world, position, CYBER_SHEEP_SYMBOL, CYBER_SHEEP_STRENGTH, CYBER_SHEEP_INITIATIVE, CYBER_SHEEP_COLOR) {}
